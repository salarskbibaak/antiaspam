...
// Rebix
elseif($textmassage=="/yalandonyal2" or $textmassage=="/yalandontal2@ M&Tro_Reykasiboty"){
    $ping=rand(34,41);
	bot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"
...
'reply_to_message_id'=>$message_id,
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"خرید ربات",'url'=>"https://t.me/yalandonya12"]
	],
              ],
        ])
   ]);
...
$ran = rand(1,3);
if ($ran == "1") {
$info_user = file_get_contents("http://www.flamingtext.com/net-fu/image_output.cgi?_comBuyRedirect=false&script=memories-anim-logo&text=$text&symbol_tagname=popular&fontsize=70&fontname=futura_poster&fontname_tagname=cool&textBorder=15&growSize=0&antialias=on&hinting=on&justify=2&letterSpacing=0&lineSpacing=0&textSlant=0&textVerticalSlant=0&textAngle=0&textOutline=off&textOutline=false&textOutlineSize=2&textColor=%260000CC&angle=0&blueFlame=on&blueFlame=false&framerate=75&frames=5& M&Trames=5&oframes=4&distance=2&transparent=off&transparent=false&extAnim=gif&animLoop=on&animLoop=false&defaultFrameRate=75&doScale=off&scaleWidth=240&scaleHeight=120&&_=1469943010141");
...
if($textmassage=="/start" && $tc == "private" or $textmassage=="/panel" && $tc == "private"){
	...
	bot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"سلام$name به ربات ضد لینڪ M&T خوش آمدید✔️
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"ورود به کانال",'url'=>"https://t.me/XXBOT5"]
	],
              ]
        ])
            ]);
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				[
                ['text'=>"⇜  خرید اشتراک ⇜ ",'url'=>'https://t.me/yalandonya12'],['text'=>"⇜  اشتراک رایگان ⇜ ",'callback_data'=>'freepv']
                ],    
			    [
...
'reply_markup'=>json_encode([
   ...
   elseif($data=="aboutus"){
            bot('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"توانایی های ربات  M&T🔲

سرعت بالا
امکانات فوق العاده
مدیریت 24  ساعته
حذف پیام های تبلیغاتی و ربات های مزاحم
ضد لینڪ M&T همون چیزی که در نظر داری رو برات فراهم میکنه
",
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				[
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                [
                    ['text'=>"اضافه کردن ربات به گروه",'url'=>'https://t.me/Reykasibot?startgroup=add']
                ],
				[
                    ['text'=>"بازگشت 🔙",'callback_data'=>'backpv']
                ],
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                [
                    ['text'=>"کد پشتیبان : 22",'url'=>'https://t.me/yalandonyal2']
                ],
                ]
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                [
                    ['text'=>"کد پشتیبان : 13",'url'=>'https://t.me/yalandonyal2']
                ],
                ]
...
» لطفا بخش مورد نظر خورد را انتخاب کنید",
	  ...
	  ['text'=>"عمومی",'callback_data'=>"allfa"],['text'=>"مدیریتی",'callback_data'=>"managefa"]
	  				    	...
	  				    	[
	  ['text'=>"قفل ها",'callback_data'=>"lockfa"],['text'=>"سودو",'callback_data'=>"sudohel M&Ta"]
	  ],
					 [
					 ['text'=>"بازگشت 🔙",'callback_data'=>'help']
					 ],
...
» لطفا بخش مورد نظر خورد را انتخاب کنید",
	  ...
	  ['text'=>"☑️عمومی",'callback_data'=>"allfapanel"],['text'=>"☑️مدیریتی",'callback_data'=>"managefapanel"]
	  				    	...
	  				    	[
	  ['text'=>"☑️قفل ها",'callback_data'=>"lockfapanel"],['text'=>"☑️سودو",'callback_data'=>"sudohel M&Tapanel"]
	  ],
					 [
					 ['text'=>"بازگشت 🔙",'callback_data'=>'helppanel']
					 ],
